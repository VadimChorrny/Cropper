...
const CropperDialog: React.FC<ICropperDialog> = ({
  ...
  const [currentImage, setCurrentImage] = useState<any>(
    'https://thumbs.dreamstime.com/b/happy-cute-little-kid-girl-choose-clothes-174609315.jpg',
  );
  ...
  // my code for change selected image

  const handleImageChange = () => {
    console.log('Image: ', image);
    console.log('Prev image: ', imgPrev.current);
